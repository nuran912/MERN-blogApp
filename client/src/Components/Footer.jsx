        ...
        <div className='w-full max-w-7xl mx-auto'>
            <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
                ...
                <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                    ...
                    <Footer.LinkGroup col>
                        <Footer.Link href='/about' target='_blank' rel='noopener noreferrer'>Nuran's Blog</Footer.Link>
                    </Footer.LinkGroup>
                    </div>
                    <div>
                    <Footer.Title title='Follow us' />
                    <Footer.LinkGroup col>
                        <Footer.Link href='https://www.github.com/nuran912' target='_blank' rel='noopener noreferrer'>Github</Footer.Link>
                    </Footer.LinkGroup>
                    <Footer.LinkGroup col>
            ...
            <div className='w-full sm:flex sm:items-center sm:justify-between'>
                <Footer.Copyright href='#' by="Nuran's Blog" year={new Date().getFullYear()}/>
